module github.com/norwoodj/bastion-pod-ctl

exclude (
	k8s.io/kubernetes/pkg/features v1.13.1
	k8s.io/kubernetes/pkg/kubectl/util/templates v1.13.1
)
...
require (
	...
	github.com/helm/helm v2.12.1+incompatible
	...
	k8s.io/apiserver v0.0.0-20181228033655-459e5d098d2b // indirect
